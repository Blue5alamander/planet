...
* [`plane/telemetry/load.hpp`](./load.hpp) -- Measures the proportion of wall-clock time a thread spends inside an instrumented scope.
...
* `planet::telemetry::thread_load` -- Audio callback load on the audio thread.
