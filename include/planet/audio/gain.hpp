...
namespace planet::audio {
    ...
    struct dB_gain {
        ...
        explicit dB_gain(linear_gain) noexcept;
        explicit dB_gain(atomic_linear_gain const &) noexcept;
        ...
        friend constexpr dB_gain operator+(dB_gain const l, dB_gain const r) {
            return dB_gain{l.dB + r.dB};
        }
        friend constexpr dB_gain operator-(dB_gain const l, dB_gain const r) {
            return dB_gain{l.dB - r.dB};
        }
