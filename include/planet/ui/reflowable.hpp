...
namespace planet::ui {
    ...
    struct reflowableX {
         ...
         */
        virtual bool is_dirty() const { return not size.has_value(); }
         ...
         *
         * Calling this is expected to also set the `size` member so that other
         ...
         */
        virtual constrained_type reflow(constrained_type const &) = 0;
