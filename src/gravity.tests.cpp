...
namespace {
    ...
    /// ## Opposing pulls are not spellable
    template<typename L, typename R>
    concept combinable = requires(L l, R r) { l | r; };
    static_assert(combinable<
                  planet::ui::gravity::horizontal,
                  planet::ui::gravity::vertical>);
    static_assert(combinable<
                  planet::ui::gravity::vertical,
                  planet::ui::gravity::horizontal>);
    static_assert(not combinable<
                  planet::ui::gravity::horizontal,
                  planet::ui::gravity::horizontal>);
    static_assert(not combinable<
                  planet::ui::gravity::vertical,
    ...
    auto const gc = felspar::testsuite(
            "gravity/centred",
            [](auto check) {
            ...
            [](auto check) {
                auto const v = planet::ui::within({}, unitbox, {4, 5});
                check(v.left()) == -1.5f;
                check(v.top()) == -2;
                check(v.right()) == 2.5f;
                check(v.bottom()) == 3;
    ...
    auto const gh = felspar::testsuite(
            ...
            [](auto check) {
                auto const v = planet::ui::within(
                        planet::ui::gravity::left, unitbox, {4, 5});
                check(v.left()) == 0;
                check(v.top()) == -2;
                check(v.right()) == 4;
                check(v.bottom()) == 3;
    ...
    auto const gv = felspar::testsuite(
            ...
            [](auto check) {
                auto const v = planet::ui::within(
                        planet::ui::gravity::top, unitbox, {4, 5});
                check(v.left()) == -1.5f;
                check(v.top()) == 0;
                check(v.right()) == 2.5f;
                check(v.bottom()) == 5;
    ...
    auto const gb = felspar::testsuite(
            "gravity/corners",
            [](auto check) {
                auto const v = planet::ui::within(
                        planet::ui::gravity::top | planet::ui::gravity::left,
                        testbox, unit);
                check(v.left()) == 2;
                check(v.top()) == 3;
                check(v.right()) == 3;
            ...
            [](auto check) {
                /// The two axes may be given in either order
                auto const v = planet::ui::within(
                        planet::ui::gravity::bottom | planet::ui::gravity::left,
                        testbox, unit);
                check(v.left()) == 2;
                check(v.top()) == 7;
                check(v.right()) == 3;
