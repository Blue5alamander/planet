...
void planet::ecs::detail::throw_entity_not_valid(
        entity_id const &eid, std::source_location const &loc) {
    throw felspar::stdexcept::logic_error{
...
namespace {
    planet::telemetry::counter create_count{"planet__ecs__entities_created"};
    planet::telemetry::counter recycle_count{"planet__ecs__entities_recycled"};
    planet::telemetry::counter destroy_count{"planet__ecs__entities_destroyed"};
}
